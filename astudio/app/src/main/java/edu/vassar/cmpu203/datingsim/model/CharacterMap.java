...
public class CharacterMap {
    ...
    //public Character zeus = new Character("Zeus", 0, zeusd, R.drawable.zeusimage, 0);
    List<String> shruckd = new ArrayList<>();
    public Character shruck = new Character("Shruck", 0, shruckd, R.drawable.shruckimage, 0);
    List<String> bonnyd = new ArrayList<>();
    public Character bonny = new Character("Bonny", 0, bonnyd, R.drawable.bonnyimage, 0);
    List<String> satand = new ArrayList<>();
    public Character satan = new Character("Satan", 0, satand, R.drawable.satanimage, 0);
    List<String> jojosond = new ArrayList<>();
    public Character jojoson = new Character("Scarlet Jojoson", 0, jojosond, R.drawable.jojosonimage, 0);
    List<String> aloned= new ArrayList<>();
    public Character alone = new Character("No one", 100, aloned, R.drawable.aloneimage, 0);
